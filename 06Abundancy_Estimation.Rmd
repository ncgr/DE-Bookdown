...
# Generate counts form the alignments directory.

```{bash, eval=FALSE}
source activate featurecounts

featureCounts -a ~/DGE_workshop/genome/GCF_000001635.27_GRCm39_genomic.gtf -o /home/$USER/DGE_workshop/count_matrix.tsv --largestOverlap -M --primary -T 10 -g gene *.bam
```
