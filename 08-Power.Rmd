...
First, load the normalized read counts.

<!-- I added in a column header for the gene column manually-->

I exported them as follows to /home/data/diffexpr/normcounts.mouse.tsv:

write.table(as.data.frame(counts(dds,normalized=TRUE)),row.names=TRUE, quote=FALSE, sep="\t", file="normcounts.tsv")


```{R, eval=FALSE}
ncnt = read.table("/home/data/diffexpr/normcounts.mouse.tsv", header=TRUE)
```
