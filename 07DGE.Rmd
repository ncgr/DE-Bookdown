...
write.table(merge(as.data.frame(stress_from_control_sorted),as.data.frame(counts(dds,normalized=TRUE)), by="row.names"), row.names=TRUE, quote=FALSE, sep="\t", file="SfromC.tsv")
```
