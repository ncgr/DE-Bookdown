...
while read line; do fasterq-dump --outdir ./ ${line}; done < /home/elavelle/DGE_workshop/SRRlist.txt
...
while read line; do mv ${line}.fastq.gz.fastp.gz ${line}.fastq.fastp.gz; done < /home/elavelle/SRRlist.tx
```
