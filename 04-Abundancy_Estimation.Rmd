...
<!-- Exercise: Which genome/annotation pair in /home/data/diffexpr/exercise_genomes/ has mismatched sequence headers? -->

<!-- ASM674v1 has .1 in the fasta but not in the gff -->

Take a look at your annotation file.

```{bash, eval=FALSE}
zcat ~/DGE_workshop/genome/GCF_000001635.27_GRCm39_genomic.gff.gz | more
```
...
But you should still stay in the alignments directory. Doublecheck.
...
Let's create a working subdirectory for DESeq2 and move the file we just made into it.
